...
class BoardDetalis extends React.Component {
    constructor(props) {
      ...
      componentDidMount() {
        ...
        axios.get(`/pins/api/v1/boards/${id}/pins/`,
        ...
        return (
          <div>
            ...
            <div className='container'>
                ...
                <div className='mt-5' >
                                    {/* <img style={{ borderRadius: '50%', marginBottom: '20px', width:'200px', height:'200px' }} src={""+details.profile_image} />
